...
$baseURL = "gest_proveedores.php?pg=" . $admin->pg . "&f=";
...
<title>Panel de Control - Administración - Gestión de Proveedores</title>
...
<div id="mainContainer">
    ...
    ?>
        ...
        <form action="gest_proveedores_do.php" method="post" onSubmit="return checkForm();">
        	
        	<h3 style="text-align:center">Datos del Proveedor</h3>
  ...
  <h2>Lista de Proveedores</h2>
        ...
        <p style="text-align:right"><a href="<?php echo $baseURL; ?>&rID=0" class='btnLink'>Nuevo Proveedor</a></p>
